...
/*When I specified the size of both char *engine[50] and char *fuel_type[10], it caused a problem with the 'double'
in the int main variables... But when I remove the size[], it works fine..??
*/
int main()
{
